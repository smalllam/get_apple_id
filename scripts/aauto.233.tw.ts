...
async function extractAppleIDs(url: string = 'https://aauto.233.tw/share/whvAdkbDeO'): Promise<AppleID[]> {
  // 启动浏览器
  ...
  const tempHtmlPath = path.join(process.cwd(), 'aauto.233.tw.html');
